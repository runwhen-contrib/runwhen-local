...
def init_components():
    ...
    component_stages_init = (
        (Stage.INDEXER, ["load_resources", "kubeapi", "azureapi", "gcpapi", "awsapi", "cloudquery", "azure_devops", "runwhen_platform", "test_synth"]),
        (Stage.ENRICHER, ["generation_rules", "test_groups"]),
