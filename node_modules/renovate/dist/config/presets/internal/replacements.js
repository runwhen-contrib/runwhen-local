...
const replacements_json_1 = tslib_1.__importDefault(require("../../../data/replacements.json"));
const auto_generate_replacements_1 = require("./auto-generate-replacements");
const { $schema, ...replacementPresets } = replacements_json_1.default;
/* eslint sort-keys: ["error", "asc", {"caseSensitive": false, "natural": true}] */
exports.presets = replacementPresets;
