...
var CAST5, G, Global, WordArray, ref, ui32a_to_ui8a, ui8a_to_ui32a;

WordArray = require('triplesec').WordArray;

ref = require('../util'), ui8a_to_ui32a = ref.ui8a_to_ui32a, ui32a_to_ui8a = ref.ui32a_to_ui8a;
...
CAST5 = (function() {
  ...
  CAST5.prototype._encrypt_ui8a = function(src) {
    var dst, i, l, len, o, r, ref1, t;
    len = src.length;
    dst = new Uint8Array(len);
    for (i = o = 0, ref1 = len; o < ref1; i = o += 8) {
  ...
  CAST5.prototype.keySchedule = function(key) {
    var a, b, half, i, j, k, ki, kw, o, p, q, results, round, s, t, u, w, x;
    t = (function() {
    ...
    x = [6, 7, 4, 5];
    ki = 0;
    for (half = o = 0; o < 2; half = ++o) {
      for (round = p = 0; p < 4; round = ++p) {
        for (j = q = 0; q < 4; j = ++q) {
    ...
    for (i = u = 0; u < 16; i = ++u) {
      this.masking[i] = k[i];
      results.push(this.rotate[i] = k[16 + i] & 0x1f);
    }
    return results;
  };
