...
var C, S2K, SHA256, SecretKeyMaterial, _iterated_s2k_cache, alloc, iterated_s2k, ref, streamers, triplesec;

triplesec = require('triplesec');

C = require('../const').openpgp;

ref = require('../hash'), alloc = ref.alloc, SHA256 = ref.SHA256, streamers = ref.streamers;
...
iterated_s2k = function(arg) {
  var alg, bigbuf, count, i, k, n, prefix, rem, rembuf, ret, seed, streamer, tot, val;
  alg = arg.alg, seed = arg.seed, count = arg.count, prefix = arg.prefix;
