...
var BigInteger, Curve, Curve25519, H, OIDS, OID_LOOKUP, OID_NAMES, SRF, SlicerBuffer, base, bn, brainpool_p256, brainpool_p384, brainpool_p512, cv25519, iced, k, kbnacl, nist_p256, nist_p384, nist_p521, uint_to_buffer, v,
...
exports.Curve = Curve = (function(superClass) {
  extend(Curve, superClass);

  function Curve(arg) {
    var Gx, Gy, a, b, h, n, p;
    p = arg.p, a = arg.a, b = arg.b, Gx = arg.Gx, Gy = arg.Gy, n = arg.n, h = arg.h, this.oid = arg.oid;
    h || (h = BigInteger.ONE);
    Curve.__super__.constructor.call(this, p, a, b, Gx, Gy, n, h);
  }

  Curve.prototype.mkpoint = function(arg) {
    var x, y;
    x = arg.x, y = arg.y;
  ...
  Curve.prototype._mpi_point_from_slicer_buffer = function(sb) {
    var b, bits, coord_bytes, n_bits, n_bytes, point, ref, x, y;
    ...
    ref = [BigInteger.fromBuffer(sb.read_buffer(coord_bytes)), BigInteger.fromBuffer(sb.read_buffer(coord_bytes))], x = ref[0], y = ref[1];
    point = this.mkpoint({
      x: x,
      y: y
    });
  ...
  Curve.prototype.mpi_point_from_slicer_buffer = function(sb) {
    ...
    err = point = null;
    try {
      ref = this._mpi_point_from_slicer_buffer(sb), err = ref[0], point = ref[1];
    } catch (error) {
      e = error;
      err = e;
    }
    ...
    __iced_it = (function(_this) {
      ...
      return function*() {
        ...
        __iced_deferrals = new iced.Deferrals(__iced_it, {
          ...
          filename: "/home/runner/work/kbpgp/kbpgp/src/ecc/curves.iced"
        });
...
exports.Curve25519 = Curve25519 = (function(superClass) {
  extend(Curve25519, superClass);

  function Curve25519(arg) {
    this.oid = arg.oid;
  }
